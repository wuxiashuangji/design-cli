...
var gulpTask = function gulpTask(outDir, callback) {
  var DIR = {
    sass: (0, _utils.getProjectPath)('/components/**/index.scss'),
  ...
  _gulp["default"].task('sass', function () {
    ...
    return _gulp["default"].src(DIR.sass).pipe((0, _gulpSass["default"])().on('error', _gulpSass["default"].logError)).pipe(_gulp["default"].dest(outDir));
  });
